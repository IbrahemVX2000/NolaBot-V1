...
export async function onCall({ message, args }) {
    try {
        ...
        let text = args.join(" ");
        let name = await global.controllers.Users.getName(senderID);

        if (!text) return message.reply("لازم تكتب نص حتى تسوي منشور ._.");
        ...
        console.error(e);
        message.reply("ايع هو ناقص انا اسوي لك انت منشور ._.");
    }
}
